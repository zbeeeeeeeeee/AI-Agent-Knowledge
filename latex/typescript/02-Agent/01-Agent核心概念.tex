...
\begin{enumerate}[itemsep=1pt, topsep=2pt]
  \item Agent 是怎么一步步从聊天机器人进化到常驻自治系统的
  \item Agent、传统编程、Workflow 到底有什么区别，什么时候该用哪个
  \item Agent = LLM + Planning + Memory + Tools 这个公式每一层负责什么
  \item ReAct、Plan-and-Execute、Reflection、Multi-Agent 这些范式到底怎么选
  \item Agent 面临的真实挑战和落地时的工程选型建议
\end{enumerate}
...
\textbf{2022 年，ChatGPT 这类产品刚火的时候}，大家主要还在和模型“对话”。能力很强，但它只能基于已有知识回答问题，不能主动调用外部工具，也不能自己完成操作。
...
\begin{itemize}[itemsep=1pt, topsep=2pt]
  ...
  \item 深度多步推理任务里，LLM 还是容易局部最优，可能看起来一直在推进，其实已经偏题了
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{/home/zhang/demos/latex_demos/Agent知识/HTML/AI Agent 核心概念：Agent Loop、Plan-and-Execute、A2A、Agentic Workflows、Tools 注册 _ JavaGuide_files/agent-core-arch.jpg}
...
\textbf{Tools（工具）}：让 LLM 能真正操作外部世界，比如查数据、调 API、读文件、执行代码。没有工具，Agent 很多时候只能停留在”建议你怎么做”。
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{/home/zhang/demos/latex_demos/Agent知识/HTML/AI Agent 核心概念：Agent Loop、Plan-and-Execute、A2A、Agentic Workflows、Tools 注册 _ JavaGuide_files/agent-loop-flow.jpg}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{/home/zhang/demos/latex_demos/Agent知识/HTML/AI Agent 核心概念：Agent Loop、Plan-and-Execute、A2A、Agentic Workflows、Tools 注册 _ JavaGuide_files/mcp-simple-diagram.jpg}
\caption*{MCP 图解}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{/home/zhang/demos/latex_demos/Agent知识/HTML/AI Agent 核心概念：Agent Loop、Plan-and-Execute、A2A、Agentic Workflows、Tools 注册 _ JavaGuide_files/context-engineering-vs-context-engineering-dimension-comparison.jpg}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{/home/zhang/demos/latex_demos/Agent知识/HTML/AI Agent 核心概念：Agent Loop、Plan-and-Execute、A2A、Agentic Workflows、Tools 注册 _ JavaGuide_files/ReAct-LLM.jpg}
\caption*{ReAct-LLM}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{/home/zhang/demos/latex_demos/Agent知识/HTML/AI Agent 核心概念：Agent Loop、Plan-and-Execute、A2A、Agentic Workflows、Tools 注册 _ JavaGuide_files/agent-react-flow.jpg}
\caption*{ReAct 模式流程}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{/home/zhang/demos/latex_demos/Agent知识/HTML/AI Agent 核心概念：Agent Loop、Plan-and-Execute、A2A、Agentic Workflows、Tools 注册 _ JavaGuide_files/agent-multi-agent-arch.jpg}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{/home/zhang/demos/latex_demos/Agent知识/HTML/AI Agent 核心概念：Agent Loop、Plan-and-Execute、A2A、Agentic Workflows、Tools 注册 _ JavaGuide_files/agent-a2a.jpg}
\caption*{A2A 协议架构}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{/home/zhang/demos/latex_demos/Agent知识/HTML/AI Agent 核心概念：Agent Loop、Plan-and-Execute、A2A、Agentic Workflows、Tools 注册 _ JavaGuide_files/agent-agentic-workflows.jpg}
\caption*{智能体工作流核心模式}
\end{figure}
