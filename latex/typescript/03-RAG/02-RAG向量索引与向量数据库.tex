...
\begin{enumerate}[itemsep=1pt, topsep=2pt]
  \item RAG 为什么需要向量数据库；
  \item Embedding 和向量检索是什么关系；
  \item 余弦距离、内积、欧氏距离怎么选；
  \item 向量索引算法是什么，常见算法有哪些；
  \item 项目里为什么用 HNSW，HNSW 和 IVFFLAT 有什么区别；
  \item 有哪些向量数据库，为什么选择 PostgreSQL + pgvector，为什么不直接用 MySQL 来做。
\end{enumerate}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{/home/zhang/demos/latex_demos/Agent知识/HTML/万字详解 RAG 向量索引算法和向量数据库 _ JavaGuide_files/rag-embedding-vector-retrieval.jpg}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{/home/zhang/demos/latex_demos/Agent知识/HTML/万字详解 RAG 向量索引算法和向量数据库 _ JavaGuide_files/rag-why-need-vector-store.jpg}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{/home/zhang/demos/latex_demos/Agent知识/HTML/万字详解 RAG 向量索引算法和向量数据库 _ JavaGuide_files/rag-vector-index-algorithms-Bjze1jhj.jpg}
\caption*{向量索引算法分类}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{/home/zhang/demos/latex_demos/Agent知识/HTML/万字详解 RAG 向量索引算法和向量数据库 _ JavaGuide_files/rag-hnsw-architecture.jpg}
\caption*{HNSW 索引架构}
\end{figure}
...
\section*{你为什么选择 PostgreSQL + pgvector？}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{/home/zhang/demos/latex_demos/Agent知识/HTML/万字详解 RAG 向量索引算法和向量数据库 _ JavaGuide_files/mysql9-vector-cannot-be-used-as-any-type-of-key.jpg}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{/home/zhang/demos/latex_demos/Agent知识/HTML/万字详解 RAG 向量索引算法和向量数据库 _ JavaGuide_files/interview-guide-architecture-diagram.jpg}
\caption*{系统架构图}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{/home/zhang/demos/latex_demos/Agent知识/HTML/万字详解 RAG 向量索引算法和向量数据库 _ JavaGuide_files/page-skill-jd-parse.jpg}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{/home/zhang/demos/latex_demos/Agent知识/HTML/万字详解 RAG 向量索引算法和向量数据库 _ JavaGuide_files/page-resume-analysis-detail.jpg}
\caption*{简历分析详情}
\end{figure}
...
\textbf{项目地址} （欢迎 Star 鼓励）：


\begin{itemize}[itemsep=1pt, topsep=2pt]
  \item Github：<https://github.com/Snailclimb/interview-guide>
  \item Gitee：<https://gitee.com/SnailClimb/interview-guide>
\end{itemize}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{/home/zhang/demos/latex_demos/Agent知识/HTML/万字详解 RAG 向量索引算法和向量数据库 _ JavaGuide_files/tutorial-overview.jpg}
\caption*{配套教程内容概览}
\end{figure}
...
\begin{itemize}[itemsep=1pt, topsep=2pt]
  ...
  \item 余弦相似度和欧氏距离有什么区别？RAG 场景下用哪个？
  ...
  \item pgvector 的 HNSW 索引在什么情况下会失效或退化为更慢的扫描？
  \item 为什么选择 PostgreSQL + pgvector？
\end{itemize}


动手时建议先把 HNSW 的图结构、IVF 的聚类原理理解清楚，再用 pgvector 或 Milvus 搭一个最小 Demo，比较不同索引参数下的召回率和延迟。\texttt{ef\_search}、\texttt{nprobe} 这些参数不要凭感觉调，最好拿真实业务问题做评测。
