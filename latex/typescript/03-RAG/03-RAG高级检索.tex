...
\begin{quote}
语言策略：\texttt{code}。正文三语言一致；检索融合与重排代码按 TypeScript 生态实现。 地图节点：\texttt{03 架构与运行机制 / 检索架构 RAG}。配套文档：\href{../03-RAG/01-RAG基础概念.md}{RAG 基础概念}、\href{../03-RAG/02-RAG向量索引与向量数据库.md}{RAG 向量索引与向量数据库}。
\end{quote}
