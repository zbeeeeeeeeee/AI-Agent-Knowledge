...
\begin{quote}
语言策略：\texttt{code}。正文三语言一致；服务骨架与容器化示例按 TypeScript 生态实现。 地图节点：\texttt{04 开发与工程化 / 部署与发布}。配套文档：\href{05-Agent可观测与追踪.md}{Agent 可观测与追踪}、\href{../05-评测与质量/01-Agent评测体系.md}{Agent 评测体系}。
\end{quote}
