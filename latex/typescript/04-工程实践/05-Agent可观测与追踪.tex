...
\begin{quote}
语言策略：\texttt{code}。正文三语言一致；采集器代码按 TypeScript 生态实现。 地图节点：\texttt{04 开发与工程化 / 可观测与调试}。配套文档：\href{06-Agent部署与发布.md}{Agent 部署与发布}、\href{04-大模型网关.md}{大模型网关}。
\end{quote}
