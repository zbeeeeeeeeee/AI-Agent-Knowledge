...
\begin{quote}
语言策略：\texttt{code}。正文三语言一致；成本追踪与滑动窗口限流代码按 Java 生态实现。 地图节点：\texttt{04 开发与工程化 / 成本与性能优化}。配套文档：\href{04-大模型网关.md}{大模型网关}、\href{05-Agent可观测与追踪.md}{Agent 可观测与追踪}。
\end{quote}
