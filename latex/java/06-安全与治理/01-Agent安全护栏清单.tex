...
\begin{quote}
语言策略：\texttt{code}。正文三语言一致；工具风控代码按 Java 生态实现。 地图节点：\texttt{06 安全与治理}。配套文档：\href{../00-概念与术语/02-Agent自主性分级.md}{Agent 自主性分级}、\href{../05-评测与质量/01-Agent评测体系.md}{Agent 评测体系}。
\end{quote}
