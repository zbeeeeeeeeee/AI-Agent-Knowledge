...
\begin{enumerate}[itemsep=1pt, topsep=2pt]
  \item RAG 是什么、为什么需要它；
  \item 检索、增强、生成三个环节怎么配合；
  \item Embedding 和相似度度量到底在做什么；
  \item RAG 和传统搜索、微调、长上下文分别适合什么场景；
  \item RAG 的优势和坑分别在哪里。
\end{enumerate}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{/home/zhang/demos/latex_demos/Agent知识/HTML/万字详解 RAG 基础概念 _ JavaGuide_files/rag-simplified-architecture-diagram.jpg}
\caption*{RAG 示意图}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{/home/zhang/demos/latex_demos/Agent知识/HTML/万字详解 RAG 基础概念 _ JavaGuide_files/rag-llm-challenges.jpg}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{/home/zhang/demos/latex_demos/Agent知识/HTML/万字详解 RAG 基础概念 _ JavaGuide_files/rag-rag-engineering-link.jpg}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{/home/zhang/demos/latex_demos/Agent知识/HTML/万字详解 RAG 基础概念 _ JavaGuide_files/rag-2-embedding-map-text-to-semantic-space.jpg}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{/home/zhang/demos/latex_demos/Agent知识/HTML/万字详解 RAG 基础概念 _ JavaGuide_files/rag-rag-vs-search-engine.jpg}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{/home/zhang/demos/latex_demos/Agent知识/HTML/万字详解 RAG 基础概念 _ JavaGuide_files/rag-2-evolution-stages.jpg}
\caption*{RAG 演进阶段}
\end{figure}
...
\textbf{数据隔离也更容易做。} 你可以在检索层实现多租户隔离和访问控制（ACL），确保用户只能看到自己权限范围内的数据。相比把敏感数据放进微调训练集，RAG 这套架构更适合做权限和合规治理。
...
\textbf{工程复杂度也不低。} 你要维护向量数据库，处理文档增量索引，持续优化检索策略，还要做权限过滤、引用溯源和评测闭环。相比直接调用 LLM API，RAG 的运维负担明显更重。
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{/home/zhang/demos/latex_demos/Agent知识/HTML/万字详解 RAG 基础概念 _ JavaGuide_files/interview-guide-architecture-diagram.jpg}
\caption*{系统架构图}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{/home/zhang/demos/latex_demos/Agent知识/HTML/万字详解 RAG 基础概念 _ JavaGuide_files/page-skill-jd-parse.jpg}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{/home/zhang/demos/latex_demos/Agent知识/HTML/万字详解 RAG 基础概念 _ JavaGuide_files/page-resume-analysis-detail.jpg}
\caption*{简历分析详情}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{/home/zhang/demos/latex_demos/Agent知识/HTML/万字详解 RAG 基础概念 _ JavaGuide_files/tutorial-overview.jpg}
\caption*{配套教程内容概览}
\end{figure}
