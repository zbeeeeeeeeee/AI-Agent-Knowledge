...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{/home/mao/demos/latex_demos/ai-agent-knowledge/HTML/一文搞懂 Harness Engineering：六层架构、上下文管理与一线团队实战 _ JavaGuide_files/harness-agent-equals-model-harness-arch.jpg}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{/home/mao/demos/latex_demos/ai-agent-knowledge/HTML/一文搞懂 Harness Engineering：六层架构、上下文管理与一线团队实战 _ JavaGuide_files/harness-engineering-layers-arch.jpg}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{/home/mao/demos/latex_demos/ai-agent-knowledge/HTML/一文搞懂 Harness Engineering：六层架构、上下文管理与一线团队实战 _ JavaGuide_files/harness-engineering-six-layer-architecture.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{/home/mao/demos/latex_demos/ai-agent-knowledge/HTML/一文搞懂 Harness Engineering：六层架构、上下文管理与一线团队实战 _ JavaGuide_files/context-utilization-40-percent-threshold-phenomenon.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{/home/mao/demos/latex_demos/ai-agent-knowledge/HTML/一文搞懂 Harness Engineering：六层架构、上下文管理与一线团队实战 _ JavaGuide_files/anthropic-three-agent-collaborative-architecture-inspired-by-gan.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{/home/mao/demos/latex_demos/ai-agent-knowledge/HTML/一文搞懂 Harness Engineering：六层架构、上下文管理与一线团队实战 _ JavaGuide_files/stripe-hybrid-state-machine-orchestration-architecture.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{/home/mao/demos/latex_demos/ai-agent-knowledge/HTML/一文搞懂 Harness Engineering：六层架构、上下文管理与一线团队实战 _ JavaGuide_files/continuously-evolving-harness-error-prevention-feedback-loop.pdf}
