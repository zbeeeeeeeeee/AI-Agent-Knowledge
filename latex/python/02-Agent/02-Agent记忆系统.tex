...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{/home/zhang/demos/latex_demos/Agent知识/HTML/AI Agent 记忆系统：短期记忆、长期记忆与记忆演化机制 _ JavaGuide_files/agent-memory-memory-taxonomy.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{/home/zhang/demos/latex_demos/Agent知识/HTML/AI Agent 记忆系统：短期记忆、长期记忆与记忆演化机制 _ JavaGuide_files/agent-memory-arch.jpg}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{/home/zhang/demos/latex_demos/Agent知识/HTML/AI Agent 记忆系统：短期记忆、长期记忆与记忆演化机制 _ JavaGuide_files/agent-memory-lifestyle.jpg}
\caption*{记忆操作的生命周期}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{/home/zhang/demos/latex_demos/Agent知识/HTML/AI Agent 记忆系统：短期记忆、长期记忆与记忆演化机制 _ JavaGuide_files/context-utilization-40-percent-threshold-phenomenon.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{/home/zhang/demos/latex_demos/Agent知识/HTML/AI Agent 记忆系统：短期记忆、长期记忆与记忆演化机制 _ JavaGuide_files/agent-memory-rag-vs-memory.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{/home/zhang/demos/latex_demos/Agent知识/HTML/AI Agent 记忆系统：短期记忆、长期记忆与记忆演化机制 _ JavaGuide_files/agent-memory-evolution.jpg}
\caption*{记忆系统的高级演化机制}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{/home/zhang/demos/latex_demos/Agent知识/HTML/AI Agent 记忆系统：短期记忆、长期记忆与记忆演化机制 _ JavaGuide_files/agent-memory-retrieval-optimization.jpg}
\caption*{长期记忆的检索优化策略}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{/home/zhang/demos/latex_demos/Agent知识/HTML/AI Agent 记忆系统：短期记忆、长期记忆与记忆演化机制 _ JavaGuide_files/agent-memory-markdown-memory-boundary.pdf}
...
这里以 \texttt{CLAUDE.md} 为例。\texttt{CLAUDE.md} 不是写完就完事，项目会演进，规则也会过时。
...
维护时可以用对话式审查：每隔几周，挑几条 \texttt{CLAUDE.md} 里的规则问 Claude，“如果我删掉这条规则，你会改变行为吗？”如果它说不会，这条规则可能就可以删。
