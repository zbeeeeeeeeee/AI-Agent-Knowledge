...
![LLM 网关示意图](../../HTML/AI 应用系统设计：从 Prompt Demo 到生产级架构 _ JavaGuide_files/llm-gateway-overview.png)
...
![Context Engineering 和 Prompt Engineering 差别](../../HTML/AI 应用系统设计：从 Prompt Demo 到生产级架构 _ JavaGuide_files/context-engineering-vs-context-engineering-dimension-comparison.png)
...
![长期记忆与 RAG（检索增强生成）的区别](../../HTML/AI 应用系统设计：从 Prompt Demo 到生产级架构 _ JavaGuide_files/agent-memory-rag-vs-memory.svg)
...
![Function Calling 完整调用链路：模型只生成调用意图，真正执行工具的是业务侧](../../HTML/AI 应用系统设计：从 Prompt Demo 到生产级架构 _ JavaGuide_files/structured-output-function-calling-function-calling-pipeline.png)
...
![工具调用安全风险分层：按风险等级匹配不同的控制策略](../../HTML/AI 应用系统设计：从 Prompt Demo 到生产级架构 _ JavaGuide_files/structured-output-function-calling-tool-call-security.png)
