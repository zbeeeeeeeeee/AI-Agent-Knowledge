...
| `04-工程实践` | Workflow/Graph/Loop、Loop Engineering、Harness Engineering、大模型网关 | 🟢 完整 |
| `05-评测与质量` | Agent 评测体系 | 🔴 待补全 |
| `06-安全与治理` | Agent 安全护栏清单 | 🔴 待补全 |
| `07-系统设计` | AI 应用系统设计（Prompt Demo → 生产级架构） | 🟢 完整 |
| `08-应用与案例` | 案例库、反模式、行业方案 | 🔴 待补全 |
| `09-生态与前沿` | 技术雷达、协议与趋势 | 🔴 待补全 |
| `10-面试` | 6 份面试题 + 模拟题库 | 🟢 完整 |

**推荐阅读顺序**：`00-概念与术语` → `01-LLM基础` → `02-Agent` → `03-RAG` → `04-工程实践` → `07-系统设计`；安全与评测专项补齐后插入生产路径，面试前刷 `10-面试`。
...
| 14 | `07-系统设计/01-AI应用系统设计.md` | 系统设计 | ✅ 分层架构接口定义（8 处） |
| 15 | `10-面试/01-AI-Agent面试题.md` | 面试 | — |
| 16 | `10-面试/02-RAG面试题.md` | 面试 | — |
| 17 | `10-面试/03-AI系统设计面试题.md` | 面试 | — |
| 18 | `10-面试/04-AI应用开发面试指南.md` | 面试 | — |
| 19 | `10-面试/05-大模型基础面试题.md` | 面试 | — |
| 20 | `10-面试/06-模拟面试题库.md` | 面试 | — |
