...
| `03-RAG` | RAG 基础概念、向量索引与向量数据库、RAG 高级检索 | 🟢 完整 |
| `04-工程实践` | Workflow/Graph/Loop、Loop/Harness、网关、可观测、部署、框架选型、上下文工程 | 🟢 完整 |
| `05-评测与质量` | Agent 评测体系 | 🟢 第二迭代已补 |
| `06-安全与治理` | Agent 安全护栏清单 | 🟢 第二迭代已补 |
| `07-系统设计` | AI 应用系统设计（Prompt Demo → 生产级架构） | 🟢 完整 |
| `08-应用与案例` | 案例库与反模式索引已补；行业方案待补 | 🟡 第三迭代已补索引 |
...
| 11 | `04-工程实践/01-Workflow-Graph与Loop.md` | 工程实践 | ✅ 文章审核工作流（Graph 完整实现） |
| 12 | `04-工程实践/02-Loop工程.md` | 工程实践 | — |
| 13 | `04-工程实践/03-Harness工程.md` | 工程实践 | — |
| 14 | `04-工程实践/04-大模型网关.md` | 工程实践 | ✅ 网关接口 / 规则路由 / Token 预算 |
| 15 | `04-工程实践/05-Agent可观测与追踪.md` | 工程实践 | ✅ 三语言 Trace / 指标采集器 |
| 16 | `04-工程实践/06-Agent部署与发布.md` | 工程实践 | ✅ 三语言服务骨架 / 容器化 |
| 17 | `04-工程实践/07-Agent框架选型对比.md` | 工程实践 | — |
| 18 | `04-工程实践/08-上下文工程.md` | 工程实践 | ✅ 三语言上下文组装器 |
| 19 | `05-评测与质量/01-Agent评测体系.md` | 评测与质量 | ✅ 三语言评测执行器 |
| 20 | `06-安全与治理/01-Agent安全护栏清单.md` | 安全与治理 | ✅ 三语言工具风控实现 |
| 21 | `07-系统设计/01-AI应用系统设计.md` | 系统设计 | ✅ 分层架构接口定义（8 处） |
| 22 | `08-应用与案例/01-案例库与反模式索引.md` | 应用与案例 | — |
| 23 | `10-面试/01-AI-Agent面试题.md` | 面试 | — |
| 24 | `10-面试/02-RAG面试题.md` | 面试 | — |
| 25 | `10-面试/03-AI系统设计面试题.md` | 面试 | — |
| 26 | `10-面试/04-AI应用开发面试指南.md` | 面试 | — |
| 27 | `10-面试/05-大模型基础面试题.md` | 面试 | — |
| 28 | `10-面试/06-模拟面试题库.md` | 面试 | — |
