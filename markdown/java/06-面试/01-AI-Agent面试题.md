...
![AI Agent 核心架构](../../../HTML/AI Agent 面试题总结 _ JavaGuide_files/agent-core-arch.jpg)

![Agent Loop 工作流程](../../../HTML/AI Agent 面试题总结 _ JavaGuide_files/agent-loop-flow.jpg)
...
![Agent 记忆分类全景图](../../../HTML/AI Agent 面试题总结 _ JavaGuide_files/agent-memory-memory-taxonomy.svg)
...
![Prompt engineering vs. context engineering](../../../HTML/AI Agent 面试题总结 _ JavaGuide_files/context-engineering-vs-prompt-engineering.jpg)
...
![Harness 和 Prompt/Context Engineering 的关系](../../../HTML/AI Agent 面试题总结 _ JavaGuide_files/harness-engineering-layers-arch.jpg)
