...
![AI Agent 核心架构](../../HTML/AI Agent 核心概念：Agent Loop、Plan-and-Execute、A2A、Agentic Workflows、Tools 注册 _ JavaGuide_files/agent-core-arch.png)
...
![Agent Loop 工作流程](../../HTML/AI Agent 核心概念：Agent Loop、Plan-and-Execute、A2A、Agentic Workflows、Tools 注册 _ JavaGuide_files/agent-loop-flow.png)
...
![MCP 图解](../../HTML/AI Agent 核心概念：Agent Loop、Plan-and-Execute、A2A、Agentic Workflows、Tools 注册 _ JavaGuide_files/mcp-simple-diagram.png)
...
![Context Engineering 和 Prompt Engineering 差别](../../HTML/AI Agent 核心概念：Agent Loop、Plan-and-Execute、A2A、Agentic Workflows、Tools 注册 _ JavaGuide_files/context-engineering-vs-context-engineering-dimension-comparison.png)
...
![ReAct-LLM](../../HTML/AI Agent 核心概念：Agent Loop、Plan-and-Execute、A2A、Agentic Workflows、Tools 注册 _ JavaGuide_files/ReAct-LLM.png)
...
![ReAct 模式流程](../../HTML/AI Agent 核心概念：Agent Loop、Plan-and-Execute、A2A、Agentic Workflows、Tools 注册 _ JavaGuide_files/agent-react-flow.png)
...
![Multi-Agent 系统架构](../../HTML/AI Agent 核心概念：Agent Loop、Plan-and-Execute、A2A、Agentic Workflows、Tools 注册 _ JavaGuide_files/agent-multi-agent-arch.png)
...
![A2A 协议架构](../../HTML/AI Agent 核心概念：Agent Loop、Plan-and-Execute、A2A、Agentic Workflows、Tools 注册 _ JavaGuide_files/agent-a2a.png)
...
![智能体工作流核心模式](../../HTML/AI Agent 核心概念：Agent Loop、Plan-and-Execute、A2A、Agentic Workflows、Tools 注册 _ JavaGuide_files/agent-agentic-workflows.png)
