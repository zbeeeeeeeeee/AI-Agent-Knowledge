...
![AI Agent 记忆系统架构](../../HTML/AI Agent 记忆系统：短期记忆、长期记忆与记忆演化机制 _ JavaGuide_files/agent-memory-arch.png)
...
![记忆操作的生命周期](../../HTML/AI Agent 记忆系统：短期记忆、长期记忆与记忆演化机制 _ JavaGuide_files/agent-memory-lifestyle.png)
...
![记忆系统的高级演化机制](../../HTML/AI Agent 记忆系统：短期记忆、长期记忆与记忆演化机制 _ JavaGuide_files/agent-memory-evolution.png)
...
![长期记忆的检索优化策略](../../HTML/AI Agent 记忆系统：短期记忆、长期记忆与记忆演化机制 _ JavaGuide_files/agent-memory-retrieval-optimization.png)
