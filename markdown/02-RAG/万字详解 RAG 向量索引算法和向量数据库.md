...
![Embedding 和向量检索是什么关系？](../../HTML/万字详解 RAG 向量索引算法和向量数据库 _ JavaGuide_files/rag-embedding-vector-retrieval.png)
...
![RAG 场景为什么需要向量数据库？](../../HTML/万字详解 RAG 向量索引算法和向量数据库 _ JavaGuide_files/rag-why-need-vector-store.png)
...
![向量索引算法分类](../../HTML/万字详解 RAG 向量索引算法和向量数据库 _ JavaGuide_files/rag-vector-index-algorithms-Bjze1jhj.png)
...
![HNSW 索引架构](../../HTML/万字详解 RAG 向量索引算法和向量数据库 _ JavaGuide_files/rag-hnsw-architecture.png)
...
![VECTOR 列不能用作任何类型的键，包括主键、外键、唯一键和分区键](../../HTML/万字详解 RAG 向量索引算法和向量数据库 _ JavaGuide_files/mysql9-vector-cannot-be-used-as-any-type-of-key.png)
...
![系统架构图](../../HTML/万字详解 RAG 向量索引算法和向量数据库 _ JavaGuide_files/interview-guide-architecture-diagram.png)

**效果图：**

![Skill 出题 + JD 解析](../../HTML/万字详解 RAG 向量索引算法和向量数据库 _ JavaGuide_files/page-skill-jd-parse.png)

![简历分析详情](../../HTML/万字详解 RAG 向量索引算法和向量数据库 _ JavaGuide_files/page-resume-analysis-detail.png)
...
![配套教程内容概览](../../HTML/万字详解 RAG 向量索引算法和向量数据库 _ JavaGuide_files/tutorial-overview.png)
