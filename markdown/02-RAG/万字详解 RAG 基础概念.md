...
![RAG（检索增强生成）如何解决 LLM 的核心挑战](../../HTML/万字详解 RAG 基础概念 _ JavaGuide_files/rag-llm-challenges.png)
...
![索引和检索阶段的简化流程图](../../HTML/万字详解 RAG 基础概念 _ JavaGuide_files/rag-rag-engineering-link.png)
...
![Embedding：把文本映射到语义空间](../../HTML/万字详解 RAG 基础概念 _ JavaGuide_files/rag-2-embedding-map-text-to-semantic-space.png)
...
![RAG 与传统搜索引擎的区别](../../HTML/万字详解 RAG 基础概念 _ JavaGuide_files/rag-rag-vs-search-engine.png)
...
![RAG 演进阶段](../../HTML/万字详解 RAG 基础概念 _ JavaGuide_files/rag-2-evolution-stages.png)
...
![系统架构图](../../HTML/万字详解 RAG 基础概念 _ JavaGuide_files/interview-guide-architecture-diagram.png)

**效果图：**

![Skill 出题 + JD 解析](../../HTML/万字详解 RAG 基础概念 _ JavaGuide_files/page-skill-jd-parse.png)

![简历分析详情](../../HTML/万字详解 RAG 基础概念 _ JavaGuide_files/page-resume-analysis-detail.png)
...
![配套教程内容概览](../../HTML/万字详解 RAG 基础概念 _ JavaGuide_files/tutorial-overview.png)
