...
![AI Agent 核心架构](../../HTML/AI Agent 面试题总结 _ JavaGuide_files/agent-core-arch.png)

![Agent Loop 工作流程](../../HTML/AI Agent 面试题总结 _ JavaGuide_files/agent-loop-flow.png)
...
![Prompt engineering vs. context engineering](../../HTML/AI Agent 面试题总结 _ JavaGuide_files/context-engineering-vs-prompt-engineering.png)
...
![Harness 和 Prompt/Context Engineering 的关系](../../HTML/AI Agent 面试题总结 _ JavaGuide_files/harness-engineering-layers-arch.png)
