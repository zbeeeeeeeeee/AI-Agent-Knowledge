...
![RAG 示意图](../../../HTML/万字详解 RAG 基础概念 _ JavaGuide_files/rag-simplified-architecture-diagram.jpeg)

## 为什么需要 RAG？

![RAG（检索增强生成）如何解决 LLM 的核心挑战](../../../HTML/万字详解 RAG 基础概念 _ JavaGuide_files/rag-llm-challenges.jpg)
...
![索引和检索阶段的简化流程图](../../../HTML/万字详解 RAG 基础概念 _ JavaGuide_files/rag-rag-engineering-link.jpg)
...
![Embedding：把文本映射到语义空间](../../../HTML/万字详解 RAG 基础概念 _ JavaGuide_files/rag-2-embedding-map-text-to-semantic-space.jpg)
...
![RAG 与传统搜索引擎的区别](../../../HTML/万字详解 RAG 基础概念 _ JavaGuide_files/rag-rag-vs-search-engine.jpg)
...
![RAG 演进阶段](../../../HTML/万字详解 RAG 基础概念 _ JavaGuide_files/rag-2-evolution-stages.jpg)
...
**数据隔离也更容易做。** 检索层可实现多租户隔离和访问控制（ACL），确保用户只能看到权限范围内的数据。相比把敏感数据放进微调训练集，RAG 这套架构更适合做权限和合规治理。
