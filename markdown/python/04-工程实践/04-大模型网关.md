...
![传统 API 网关示意图](../../../HTML/大模型网关详解：多模型路由、Fallback、限流与成本控制 _ JavaGuide_files/api-gateway-overview.jpg)
...
![LLM 网关示意图](../../../HTML/大模型网关详解：多模型路由、Fallback、限流与成本控制 _ JavaGuide_files/llm-gateway-overview.jpg)
