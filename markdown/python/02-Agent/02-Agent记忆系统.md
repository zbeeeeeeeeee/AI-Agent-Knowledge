...
![Agent 记忆分类全景图](../../../HTML/AI Agent 记忆系统：短期记忆、长期记忆与记忆演化机制 _ JavaGuide_files/agent-memory-memory-taxonomy.svg)

记忆系统通常分两层：短期记忆和长期记忆。短期记忆是 Session 级的，服务当前任务；长期记忆是跨 Session 的，负责把用户偏好、历史决策、过往经验沉淀下来。两者在物理和逻辑上都应该分开，不要混成一锅。

![AI Agent 记忆系统架构](../../../HTML/AI Agent 记忆系统：短期记忆、长期记忆与记忆演化机制 _ JavaGuide_files/agent-memory-arch.jpg)
...
![记忆操作的生命周期](../../../HTML/AI Agent 记忆系统：短期记忆、长期记忆与记忆演化机制 _ JavaGuide_files/agent-memory-lifestyle.jpg)
...
![上下文利用率的 40% 阈值现象](../../../HTML/AI Agent 记忆系统：短期记忆、长期记忆与记忆演化机制 _ JavaGuide_files/context-utilization-40-percent-threshold-phenomenon.svg)
...
![长期记忆与 RAG（检索增强生成）的区别](../../../HTML/AI Agent 记忆系统：短期记忆、长期记忆与记忆演化机制 _ JavaGuide_files/agent-memory-rag-vs-memory.svg)
...
![记忆系统的高级演化机制](../../../HTML/AI Agent 记忆系统：短期记忆、长期记忆与记忆演化机制 _ JavaGuide_files/agent-memory-evolution.jpg)
...
![长期记忆的检索优化策略](../../../HTML/AI Agent 记忆系统：短期记忆、长期记忆与记忆演化机制 _ JavaGuide_files/agent-memory-retrieval-optimization.jpg)
...
![Markdown 记忆和传统长期记忆的适用边界](../../../HTML/AI Agent 记忆系统：短期记忆、长期记忆与记忆演化机制 _ JavaGuide_files/agent-memory-markdown-memory-boundary.svg)
...
以 `CLAUDE.md` 为例。`CLAUDE.md` 不是写完就完事，项目会演进，规则也会过时。
...
维护时做对话式审查：每隔几周挑几条 `CLAUDE.md` 规则询问 Claude“删除这条规则是否影响行为”；若无影响，可删除。
