...
![Token 化过程示例](../../../HTML/LLM 运行机制：Token、上下文窗口与采样参数怎么影响输出 _ JavaGuide_files/llm-token-process.jpg)
...
![上下文窗口（Context Window）= LLM 的「工作记忆」](../../../HTML/LLM 运行机制：Token、上下文窗口与采样参数怎么影响输出 _ JavaGuide_files/llm-context-window.jpg)
...
![Temperature 参数：控制模型输出的随机性](../../../HTML/LLM 运行机制：Token、上下文窗口与采样参数怎么影响输出 _ JavaGuide_files/llm-temperature-params.jpg)
