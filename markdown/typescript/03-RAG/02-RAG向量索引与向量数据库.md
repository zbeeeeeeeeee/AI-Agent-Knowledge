...
![Embedding 和向量检索是什么关系？](../../../HTML/万字详解 RAG 向量索引算法和向量数据库 _ JavaGuide_files/rag-embedding-vector-retrieval.jpg)
...
![RAG 场景为什么需要向量数据库？](../../../HTML/万字详解 RAG 向量索引算法和向量数据库 _ JavaGuide_files/rag-why-need-vector-store.jpg)
...
![向量索引算法分类](../../../HTML/万字详解 RAG 向量索引算法和向量数据库 _ JavaGuide_files/rag-vector-index-algorithms-Bjze1jhj.jpg)
...
![HNSW 索引架构](../../../HTML/万字详解 RAG 向量索引算法和向量数据库 _ JavaGuide_files/rag-hnsw-architecture.jpg)
...
![VECTOR 列不能用作任何类型的键，包括主键、外键、唯一键和分区键](../../../HTML/万字详解 RAG 向量索引算法和向量数据库 _ JavaGuide_files/mysql9-vector-cannot-be-used-as-any-type-of-key.jpg)
...
![系统架构图](../../../HTML/万字详解 RAG 向量索引算法和向量数据库 _ JavaGuide_files/interview-guide-architecture-diagram.jpg)

**效果图：**

![Skill 出题 + JD 解析](../../../HTML/万字详解 RAG 向量索引算法和向量数据库 _ JavaGuide_files/page-skill-jd-parse.jpg)

![简历分析详情](../../../HTML/万字详解 RAG 向量索引算法和向量数据库 _ JavaGuide_files/page-resume-analysis-detail.jpg)
...
先理解 HNSW 的图结构和 IVF 的聚类原理，再用 pgvector 或 Milvus 搭最小 Demo，比较不同索引参数下的召回率和延迟。`ef_search`、`nprobe` 参数应基于真实业务问题评测。
