...
![Agent = Model + Harness](../../HTML/一文搞懂 Harness Engineering：六层架构、上下文管理与一线团队实战 _ JavaGuide_files/harness-agent-equals-model-harness-arch.png)
...
![Harness 和 Prompt/Context Engineering 的关系](../../HTML/一文搞懂 Harness Engineering：六层架构、上下文管理与一线团队实战 _ JavaGuide_files/harness-engineering-layers-arch.png)
...
![上下文利用率的 40% 阈值现象](../../HTML/一文搞懂 Harness Engineering：六层架构、上下文管理与一线团队实战 _ JavaGuide_files/context-utilization-40-percent-threshold-phenomenon.svg)
...
![Anthropic 三智能体协同架构（受 GAN 启发）](../../HTML/一文搞懂 Harness Engineering：六层架构、上下文管理与一线团队实战 _ JavaGuide_files/anthropic-three-agent-collaborative-architecture-inspired-by-gan.svg)
...
![Stripe 混合状态机编排架构](../../HTML/一文搞懂 Harness Engineering：六层架构、上下文管理与一线团队实战 _ JavaGuide_files/stripe-hybrid-state-machine-orchestration-architecture.svg)
...
![持续进化的 Harness 防错反馈闭环](../../HTML/一文搞懂 Harness Engineering：六层架构、上下文管理与一线团队实战 _ JavaGuide_files/continuously-evolving-harness-error-prevention-feedback-loop.svg)
