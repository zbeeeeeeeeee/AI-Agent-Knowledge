...
![Agent Loop 工作流程](../../HTML/Loop Engineering 是什么？为什么说它是新瓶装旧酒？ _ JavaGuide_files/agent-loop-flow.png)
...
![Context Engineering 和 Prompt Engineering 差别](../../HTML/Loop Engineering 是什么？为什么说它是新瓶装旧酒？ _ JavaGuide_files/context-engineering-vs-context-engineering-dimension-comparison.png)
...
![Harness 和 Prompt/Context Engineering 的关系](../../HTML/Loop Engineering 是什么？为什么说它是新瓶装旧酒？ _ JavaGuide_files/harness-engineering-layers-arch.png)
...
![Agent 执行链路](../../HTML/Loop Engineering 是什么？为什么说它是新瓶装旧酒？ _ JavaGuide_files/skills-agent-execution-link.png)
...
![MCP 图解](../../HTML/Loop Engineering 是什么？为什么说它是新瓶装旧酒？ _ JavaGuide_files/mcp-simple-diagram.png)
...
![Claude Code 推荐使用 loop 命令](../../HTML/Loop Engineering 是什么？为什么说它是新瓶装旧酒？ _ JavaGuide_files/claudecode-father-loop.png)
