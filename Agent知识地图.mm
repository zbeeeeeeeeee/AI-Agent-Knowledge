...
<node TEXT="AI Agent 知识总索引">
  <node TEXT="00 阅读入口" LINK="markdown/README.md">
    <node TEXT="按角色阅读">
      ...
      <node TEXT="🟡 架构师" LINK="markdown/java/05-系统设计/01-AI应用系统设计.md"/>
      <node TEXT="🟢 面试冲刺" LINK="markdown/java/06-面试/04-AI应用开发面试指南.md"/>
    </node>
    <node TEXT="按生命周期">
      <node TEXT="🟢 概念入门" LINK="markdown/java/README.md"/>
      <node TEXT="🟢 系统开发" LINK="markdown/java/04-工程实践/01-Workflow-Graph与Loop.md"/>
      <node TEXT="🟡 评测上线" LINK="markdown/java/05-系统设计/01-AI应用系统设计.md"/>
      <node TEXT="🟡 运营治理" LINK="markdown/java/04-工程实践/04-大模型网关.md"/>
    </node>
    <node TEXT="三语言版本">
      <node TEXT="🟢 Java 原版" LINK="markdown/java/README.md"/>
      <node TEXT="🟢 Python 版" LINK="markdown/python/README.md"/>
      <node TEXT="🟢 TypeScript 版" LINK="markdown/typescript/README.md"/>
      <node TEXT="🟢 PDF 版" LINK="pdf"/>
    </node>
  </node>
  <node TEXT="🟡 01 概念与分类" LINK="markdown/java/02-Agent/01-Agent核心概念.md">
    <node TEXT="🟡 Agent 定义与边界" LINK="markdown/java/02-Agent/01-Agent核心概念.md">
      ...
      <node TEXT="🟡 Agent vs Chatbot" LINK="markdown/java/06-面试/06-模拟面试题库.md"/>
  ...
  <node TEXT="🟡 02 能力模型" LINK="markdown/java/02-Agent/01-Agent核心概念.md">
    ...
    <node TEXT="🟡 协作与沟通" LINK="markdown/java/02-Agent/01-Agent核心概念.md">
      <node TEXT="🟡 多智能体协作" LINK="markdown/java/02-Agent/01-Agent核心概念.md"/>
  ...
  <node TEXT="🟡 03 架构与运行机制" LINK="markdown/java/02-Agent/01-Agent核心概念.md">
    ...
    <node TEXT="🟢 模型接入层" LINK="markdown/java/04-工程实践/04-大模型网关.md">
      ...
      <node TEXT="🟢 结构化输出" LINK="markdown/java/01-LLM基础/02-大模型结构化输出.md"/>
    ...
    <node TEXT="🔴 多智能体编排" LINK="markdown/java/02-Agent/01-Agent核心概念.md">
      <node TEXT="🔴 编排模式"/>
      <node TEXT="🟡 通信协议" LINK="markdown/java/02-Agent/01-Agent核心概念.md"/>
    </node>
  </node>
  <node TEXT="🟡 04 开发与工程化" LINK="markdown/java/05-系统设计/01-AI应用系统设计.md">
    ...
    <node TEXT="🟡 上下文工程" LINK="markdown/java/05-系统设计/01-AI应用系统设计.md">
      <node TEXT="🟡 Prompt 版本化" LINK="markdown/java/05-系统设计/01-AI应用系统设计.md"/>
      <node TEXT="🟢 RAG 与 Memory 边界" LINK="markdown/java/02-Agent/02-Agent记忆系统.md"/>
      <node TEXT="🟡 Token 预算与上下文压缩" LINK="markdown/java/05-系统设计/01-AI应用系统设计.md"/>
    </node>
    <node TEXT="🟢 系统设计" LINK="markdown/java/05-系统设计/01-AI应用系统设计.md">
      <node TEXT="🟢 生产级分层架构" LINK="markdown/java/05-系统设计/01-AI应用系统设计.md"/>
      <node TEXT="🟢 同步 流式 异步模式" LINK="markdown/java/05-系统设计/01-AI应用系统设计.md"/>
      <node TEXT="🟢 工具调用与权限模型" LINK="markdown/java/05-系统设计/01-AI应用系统设计.md"/>
    </node>
    ...
    <node TEXT="🟡 可观测与调试" LINK="markdown/java/04-工程实践/04-大模型网关.md">
      <node TEXT="🟡 Trace 记录" LINK="markdown/java/05-系统设计/01-AI应用系统设计.md"/>
      <node TEXT="🔴 日志与回放"/>
      <node TEXT="🔴 调试工具链"/>
    </node>
  </node>
  <node TEXT="🔴 05 评测与质量" LINK="markdown/java/05-系统设计/01-AI应用系统设计.md">
    <node TEXT="🟡 指标体系" LINK="markdown/java/05-系统设计/01-AI应用系统设计.md">
      <node TEXT="🔴 任务成功率"/>
      <node TEXT="🔴 轨迹质量"/>
      <node TEXT="🔴 工具调用准确率"/>
      <node TEXT="🟡 延迟与成本" LINK="markdown/java/04-工程实践/04-大模型网关.md"/>
    </node>
    <node TEXT="🟡 评测方法" LINK="markdown/java/05-系统设计/01-AI应用系统设计.md">
      <node TEXT="🔴 离线评测集"/>
      <node TEXT="🔴 人工评测"/>
      <node TEXT="🔴 在线 A B 实验"/>
    ...
    <node TEXT="🟡 持续改进" LINK="markdown/java/04-工程实践/03-Harness工程.md">
      <node TEXT="🟡 Human-in-the-Loop" LINK="markdown/java/05-系统设计/01-AI应用系统设计.md"/>
      <node TEXT="🟡 反馈闭环" LINK="markdown/java/04-工程实践/03-Harness工程.md"/>
    </node>
  </node>
  <node TEXT="🟡 06 安全与治理" LINK="markdown/java/05-系统设计/01-AI应用系统设计.md">
    <node TEXT="🟡 风险分类" LINK="markdown/java/05-系统设计/01-AI应用系统设计.md">
      <node TEXT="🟡 模型风险" LINK="markdown/java/05-系统设计/01-AI应用系统设计.md"/>
      <node TEXT="🟡 工具风险" LINK="markdown/java/05-系统设计/01-AI应用系统设计.md"/>
      <node TEXT="🟡 数据风险" LINK="markdown/java/05-系统设计/01-AI应用系统设计.md"/>
    </node>
    <node TEXT="🟡 护栏机制" LINK="markdown/java/05-系统设计/01-AI应用系统设计.md">
      <node TEXT="🟡 权限最小化" LINK="markdown/java/05-系统设计/01-AI应用系统设计.md"/>
      <node TEXT="🔴 沙箱执行"/>
      <node TEXT="🔴 Prompt 注入防护"/>
      <node TEXT="🔴 内容安全"/>
    </node>
    <node TEXT="🟡 合规与审计" LINK="markdown/java/04-工程实践/04-大模型网关.md">
      <node TEXT="🟡 隐私与数据边界" LINK="markdown/java/05-系统设计/01-AI应用系统设计.md"/>
      <node TEXT="🟡 审计日志" LINK="markdown/java/04-工程实践/04-大模型网关.md"/>
      <node TEXT="🟡 第三方模型数据边界" LINK="markdown/java/05-系统设计/01-AI应用系统设计.md"/>
    </node>
    <node TEXT="🔴 责任与流程">
      <node TEXT="🔴 审批流程"/>
      <node TEXT="🔴 责任归属"/>
